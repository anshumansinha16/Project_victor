...
class Encoder(nn.Module):
    def __init__(self, input_dim1, hidden_dim1, latent_dim1, input_dim2, hidden_dim2, latent_dim2, input_dim3, hidden_dim3, latent_dim3, hidden_layers, y_dim, latent_dim, act_type, act_args):
        super().__init__()
        ...
        dims_arr2 = np.concatenate(([input_dim + y_dim], dims_arr2))
        ...
        dims_arr3 = np.concatenate(([input_dim + y_dim], dims_arr3))
...
class Decoder(nn.Module):
    def __init__(self, latent_dim, hidden_dim1, output_dim1, hidden_dim2, output_dim2, hidden_dim3 output_dim3, hidden_layers, y_dim, act_type, act_args):
        super().__init__()
        ...
        self.hidden_to_out = nn.Linear(hidden_dim1+hidden_dim2+hidden_dim3, output_dim3)
